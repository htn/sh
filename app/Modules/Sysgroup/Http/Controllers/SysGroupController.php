...
namespace App\Modules\Sysgroup\Http\Controllers;
...
class SysGroupController extends Controller {
    ...
    public function index() {
        ...
        return view('sysgroup::view', compact('header'));
    }
    ...
    public function grid(Request $request) {
        if ($request->ajax()) {
            ...
            $data = json_encode(array(
                'l' => view('sysgroup::list', compact('items', 'cols', 'header'))->render(),
                'p' => view('sysgroup::pagination', compact('items', 'cols'))->render()
            ));
            return $data;
        }
    }
