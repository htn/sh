      ...
      <div id="dialogbox" class="dialogbox" style="display:none;">\
        ...
        prompt: function (data) {
            ...
            if (time) {
                ...
                promptAuto = setTimeout(function () {
                    $('.dialogPrompt').stop(true, true).fadeOut(function () {
                        $(this).remove()
                    });
                }, time);
            }
        ...
        reveal: function (data) {
            ...
            if (data && data.type == 'msg') {/*********************************打开对话框*********************************/
                ...
                if (data.icon && data.icon == 0)
                    icon = url_tmpl + 'resources/plugins/dialogbox/img/dailogbox_warning_icon.png';
                if (data.icon && data.icon == 1)
                    icon = url_tmpl + 'resources/plugins/dialogbox/img/dailogbox_success_icon.png';
                if (data.content) {
                ...
                if (content)
                    iframeHtml = '<div class="dialogTopTips">' + content + '</div>' + iframeHtml;
                content = iframeHtml;
        ...
        showOverlay: function (data) {
            ...
            if (!$(".dialogboxOverlay").length)
                $("body").append('<div class="dialogboxOverlay"></div>');
